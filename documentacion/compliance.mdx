...
- SetProfile: un punto final que recibe y almacena toda la información relevante para un usuario mencionado anteriormente.
...
CheckProfile: un endpoint para verificar el estado de un usuario. Para proteger la información del usuario, solo devolverá si cada uno de los atributos están correctamente registrados, en qué país puede operar el usuario y si puede operar.
