...
- <b>CreateAccount</b>: un punto final para crear una nueva cuenta. Necesita enviar todos sus datos básicos para poder operar.
- <b>UpdateAccount</b>: un punto final que recibe y almacena toda la información del usuario. Podrá actualizar su información personal.
