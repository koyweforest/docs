...
opcional: `bankCode`, `documentNumber`, `paymentMethodId`
...
Es necesario incluir el paymentMethodId. Este ID representa al proveedor de pagos (https://docs.koywe.com/english/documentation/api-documentation/restful-api/Payout-provider/Returns-a-list-of-available-payout-providers-for-a-given-currency).
