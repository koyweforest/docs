...
<Accordion title="Servicios de cliente">

#### Actualizar webhook

Actualiza los webhooks del cliente
...
#### Actualizar webhook de validación

Actualiza los webhooks de validación del cliente
