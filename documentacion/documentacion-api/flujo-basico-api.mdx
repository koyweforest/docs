...
<b>On ramp</b>: Carga la lista de medios de pago disponibles. En este endpoint podrás encontrar los datos de transferencia para cada país, por lo que puede ser un buen momento para mostrarlos al usuario si es que selecciona ese medio de pago.

<b>Off ramp</b>: Carga la lista de medios de dispersión disponibles. Podrás encontrar los precios y tiempos de cada uno.
...
<Tip>
  ...
  El `id` del `bankAccount` debe ser ingresado en el campo `destinationAddress` del request.
</Tip>
