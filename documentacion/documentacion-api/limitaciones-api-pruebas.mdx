...
Algunos métodos de pago restringen la cantidad de dinero que puedes usar en entornos de prueba. Recomendamos la realización de pruebas con menos de 50 dólares o la cantidad equivalente en moneda local para evitar errores.
...
1. Creamos usuarios utilizando `setProfile` para cada uno de los países que queremos probar.
...
8. Esperamos los webhooks y las confirmaciones de cadena de bloques, consultando ocasionalmente el punto final de pedidos para verificar el estado.
...
5. Esperamos los webhooks y las confirmaciones de cadena de bloques, consultando ocasionalmente el punto final de pedidos para verificar el estado.
