...
<Warning>El SDK está actualmente en Beta. Si tienes problemas, escríbenos a [hola@koywe.com](mailto:hola@koywe.com)</Warning>
...
Necesitarás configurar un punto final de API para asegurarte de que tu usuario esté identificado y proporcionarnos la información.</Warning>
