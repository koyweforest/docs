...
Podrás definir una URL para recibir llamados cada vez que se gatille un evento
cuando suceda algo importante para una transacción específica. Los posibles
eventos son:
