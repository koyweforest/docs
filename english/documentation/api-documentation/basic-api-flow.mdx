...
## Glossary
 - <b>email:</b> The email address that will be associated with the user.
 - <b>document:</b>
    ...
    - <b>isCompany:</b> Type of person to register. If true, the account to be registered will be a legal entity. Otherwise, an individual.
