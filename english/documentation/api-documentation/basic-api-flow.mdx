...
<Tip>
  For off ramps, you will need to create a bank account for the user. Check the docs to see how to do this.
  The `bankAccount` `id` should be added to the `destinationAddress` field.
</Tip>
...
<Tip>
  If the quote has expired, a new one need to be generated.
</Tip>
