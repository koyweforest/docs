...
These user account services allow managing user information in order to operate later.
See [Considerations](/english/documentation/api-documentation/basic-api-flow#accounts)

#### Check account

Checks user account data and determines whether they can perform any operation or not.
...
Returns order information. Receives a `quoteId`.
