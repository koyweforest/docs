...
Some payment methods restrict the amount of fiat you can use on testing environments (for Khipu it's around 25 USD maximum, for Palomma it's around 1.25 USD minimum, in the local currencies).
